...
export default function AboutProject() {
  return (
    <div className="bg-slate-800/30 border border-slate-700 p-8 rounded-3xl mb-12 mt-12">
      <div className="max-w-3xl">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <FeatureCard icon={<Zap className="text-yellow-400"/>} title="Instant AI" desc="Powered by high accuracy." />
